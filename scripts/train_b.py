...
def train(
    ...
    best_ckpt_path = os.path.join(CHECKPOINT_DIR, f"best_model_b_{dt}.pt")
    latest_ckpt_path = os.path.join(CHECKPOINT_DIR, f"latest_model_b_{dt}.pt")
...
def main():
    ...
    for dt in [4]:
        ...
        warmup_epochs, total_epochs = 2, 30
